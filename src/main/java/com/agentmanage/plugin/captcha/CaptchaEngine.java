...
public class CaptchaEngine extends ListImageCaptchaEngine {
    ...
    private final static Logger logger = LoggerFactory.getLogger(CaptchaEngine.class);
     ...
     * 随机字符
     */
    private static final String CHAR_STRING = "ABCDEFGHIJKLMNOPQRSTUVWXYZSZHZOZPZXZXZ0123456789";

    /**
     * 随机背景图片路径
     */
    protected static final String BACKGROUND_IMAGE_PATH;
    ...
    static {
        BACKGROUND_IMAGE_PATH = CaptchaEngine.class.getResource("/").getPath() + "../../resources/captcha/";
    }
    ...
    protected void buildInitialFactories() {
        ...
        BackgroundGenerator backgroundGenerator = new FileReaderRandomBackgroundGenerator(100/* IMAGE_WIDTH */,
                40/* IMAGE_HEIGHT */, BACKGROUND_IMAGE_PATH);
